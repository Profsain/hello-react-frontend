...
- Have a basic knowledge of `React` and `OOP` concept
- Have a general understanding of what testing is
- Have `visual-studio code` or any other code editor installed on your computer.

### Setup
- In order to get a copy of this project you need to download it from https://github.com/Profsain/hello-react-frontend
...
Feel free to check the [issues page](https://github.com/Profsain/hello-react-frontend/issues/).
